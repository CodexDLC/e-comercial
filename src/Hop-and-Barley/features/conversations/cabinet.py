...
@notification_registry.register("conversations")
def _conversations_bell(request: HttpRequest) -> object:
...
@DashboardSelector.extend(cache_key="conversations_stats", cache_ttl=0)
...
declare(
    ...
    dashboard_widgets=[
        DashboardWidget(
            ...
            context_key="conversations_stats",
            order=1,
            col="col-lg-3",
        )
    ],
