...
class Message(models.Model):
    ...
    class Topic(models.TextChoices):
        ...
        ORDER = "order", _("Order Status")
        SHIPPING = "shipping", _("Delivery & Shipping")
        ADVICE = "advice", _("Brewing Advice")
        WHOLESALE = "wholesale", _("Wholesale & Partnership")
        OTHER = "other", _("Other")
    ...
    # ── Classification ───────────────────────────────────────────────────────
    topic = models.CharField(_("topic"), max_length=30, choices=Topic.choices, default=Topic.OTHER, db_index=True)
